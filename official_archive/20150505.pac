...
//    return "PROXY proxy3.yzu.edu.tw:8080";
	...
	else if (isInNet(myIpAddress(),"140.138.32.0","255.255.255.0")
			 || isInNet(myIpAddress(),"140.138.223.0","255.255.255.0")
			 ...
			 || isInNet(myIpAddress(),"140.138.239.0","255.255.255.128")
